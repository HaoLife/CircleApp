...
public record InMemoryKeyValueStorage(ILogger<InMemoryKeyValueStorage> Logger) : IKeyValueStorage
{
    public const string Name = "InMemory";

    private readonly Uno.Extensions.Threading.FastAsyncLock _lock = new Uno.Extensions.Threading.FastAsyncLock();
